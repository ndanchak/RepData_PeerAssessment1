...
The maximum steps this guy perform at the `r Max_Steps_Interval` time interval(maybe he or she is going to work at this time).
...
NumNA <- dim(DataNA)[1]
```
There are `r NumNA` rows with missed steps.
